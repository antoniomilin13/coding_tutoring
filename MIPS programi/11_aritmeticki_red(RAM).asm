...
#int pof2[16] ={ 1, 2, 4, 8, 16, 32, 64,...}	- deklaracija + inicijalizacija
# pof2: .word 1, 2, 4, 8, 16, 32,...		- asembleru naredujemo da za svaku navedenu vrijednost rezervira po 4 bajta(word)
